...
const media = {
  home: { src: "/photos/optimized/portucana-home-page.webp", alt: "Privacy-safe Power Apps Time Off Portal home screen with illustrative leave balances.", title: "Employee Home", caption: "A role-aware starting point for balances, requests, history, and policy access.", width: 953, height: 1651 },
  employees: { src: "/photos/optimized/portucana-my-employees.webp", alt: "Privacy-safe manager My Employees screen with illustrative balances and manager actions.", title: "Manager Workspace", caption: "Managers can review employee balances, edit entitlements, or log time off directly.", width: 943, height: 1668 },
  mainFlow: { src: "/photos/optimized/portucana-main-flow.webp", alt: "Expanded Power Automate main request workflow with nested conditions and processing branches.", title: "Main Request Processing Workflow", caption: "The full orchestration path for validation, decisions, state updates, calendar work, and communication.", width: 1274, height: 1646 },
  rollover: { src: "/photos/optimized/portucana-rollover.webp", alt: "Scheduled Power Automate flow that creates missing leave-year balance records for active employees.", title: "Annual Leave-Year Rollover", caption: "A scheduled flow checks active employees and creates only the missing record for the new leave year.", width: 820, height: 909 },
  submission: { src: "/photos/optimized/portucana-submission-email.webp", alt: "Privacy-safe time-off request submission email with neutral employee and manager details.", title: "01 · Submitted", caption: "The manager and administrator receive a structured summary and clear next action.", width: 1483, height: 1061 },
  approved: { src: "/photos/optimized/portucana-approved-email.webp", alt: "Privacy-safe manager-logged time-off approval email with neutral employee details.", title: "02 · Approved", caption: "The message confirms the dates, total day value, decision, and system updates.", width: 1366, height: 1152 },
  cancelled: { src: "/photos/optimized/portucana-cancelled-email.webp", alt: "Privacy-safe approved time-off cancellation email with neutral employee details.", title: "03 · Cancelled", caption: "Cancellation confirms the balance return, calendar removal, and completed notifications.", width: 1443, height: 1090 },
  calendar: { src: "/photos/optimized/portucana-calendar.webp", alt: "Privacy-safe SharePoint Vacation Calendar with neutral employee event labels.", title: "Shared Vacation Calendar", caption: "Approved leave appears on the operational calendar on the dates employees and managers expect.", width: 1945, height: 809 },
  sharepoint: { src: "/photos/optimized/portucana-sharepoint-list.webp", alt: "Privacy-safe SharePoint Vacation Calendar list showing request IDs, dates, day values, and processing state.", title: "Operational SharePoint Data", caption: "Request-linked calendar records expose the status fields the automation uses to stay consistent.", width: 1913, height: 822 },
